...
\begin{equation}
  \Xset(\veclambda) = \left\{
    ...
    v \ge v_{\min},\; m \ge m_{\mathrm{dry}}
  \right\},
  \label{eq:X}
\end{equation}
...
\begin{equation}
  \veclambda = \begin{bmatrix}
    ...
    m_{\mathrm{dry}} & m_{\mathrm{res}} & s_{\max}
  \end{bmatrix}^{T},
\end{equation}
with
\begin{equation}
...
\begin{equation}
  ...
  \begin{cases}
    \{\mathrm{nom}, \mathrm{boost}\},
      & q = \mathrm{nom},\;
        s < s_{\max},\;
        m > m_{\mathrm{dry}} + m_{\mathrm{res}},\;
        t - t_{q} \ge \Delta t_{\mathrm{dwell}}, \\[4pt]
    \{\mathrm{nom}, \mathrm{boost}\},
      & q = \mathrm{boost},\;
        s < s_{\max},\;
        m > m_{\mathrm{dry}} + m_{\mathrm{res}},\;
...
$\Delta t_{\mathrm{dwell}}$ is a minimum dwell time.
