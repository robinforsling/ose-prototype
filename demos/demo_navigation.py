"""
Exercises the INS/GNSS navigation system against the vehicle model.
...
from ose.resource.navigation import InsGnssNavigation, AdditiveNoiseNavigation
...
def run():
    ...
    nav = InsGnssNavigation(vehicle, state, rng=rng)
    ...
    while t < T_END:
        ...
        est = nav.update(t, DT, state, cmd, disturbance)
